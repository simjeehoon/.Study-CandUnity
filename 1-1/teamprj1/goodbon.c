...
int main(void)
{
	int okletter = 0, totalletter = 0, speedletter = 0; //맞은 문자수, 전체 문자수 : 정확도 및 현재타수 검사에 사용
	int i = 0, a, r, b, pvs;
	int ongoing = 0; //진행도
	...
	while(i < 5)
	{
		...
		if (pointing < strlen(moongoo[r]))
			totalletter += strlen(moongoo[r]) - pointing;
